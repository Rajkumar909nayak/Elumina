...
test(` . @Pre-Request Verify Elumina Login and create exam3 `, async ({ eluminaLoginPage, eluminaRegPage, eluminaExamPage, webActions }) => {
    ...
    await test.step(`Navigate to exam Tab and Create New Exam`, async () => {
        ...
        await newtab1.bulkUploadUserswithvalidfeilds('lib/Images/Sample User_50-57.csv')
        await newtab1.BulkDownloadUserDetails("bulkUserCredentialForMinimalTimeExam.xlsx");
        await newtab1.addInv();
        await newtab1.searchUserForAddingInv(2, "bulkUserCredentialForMinimalTimeExam.xlsx")
    });
});
