...
test(`iEX_TC_ID_133,iEX_TC_ID_132. @iExamSerialRegression Verify Validation of "Pause Exam" from Live monitor`, async ({ eluminaCandPage, eluminaCadInvPage, eluminaProctorCand, webActions }) => {
